...
export default [
  ...
  },
  {
    ...
    "id": "buttermilk-penna-cotta",
    "titleImage": "https://res.cloudinary.com/hksqkdlah/image/upload/ar_1:1,c_fill,dpr_2.0,f_auto,fl_lossy.progressive.strip_profile,g_faces:auto,q_auto:low,w_344/SFS_buttermilk_pannaCotta_honey_raspberriesBlackberries-14_1_d8vrmi",
    ...
    "steps": [
      {
        "description": "Whisk sugar, gelatin, and salt in small saucepan until very well combined. Whisk in cream and let sit for 5 minutes.",
        "time": {
          "value": 5,
          "units": "minutes"
        },
        ...
        "description": "Cut vanilla bean in half lengthwise. Using tip of paring knife, scrape out seeds. Add bean and seeds to cream mixture. Cook over medium heat, stirring occasionally, until mixture registers 150 to 160 degrees, about 5 minutes.",
        "ingredients": [
          {
            "name": "vanilla bean",
            "amount": {
        ...
        "description": "Remove from heat and let mixture cool to 105 to 110 degrees, about 15 minutes."
      },{
        "time": {
          "value": 1,
          "units": "minutes"
        },
        "description": "Strain cream mixture through fine-mesh strainer into medium bowl, pressing on solids to extract as much liquid as possible. Gently whisk in buttermilk.",
        "ingredients": [
          {
            "name": "buttermilk",
            "amount": {
